...
const ORDER_TABS: TabConfig[] = [
  ...
  { id: 'ready', label: 'Готовые', icon: FaCheckCircle, color: 'from-green-500 to-emerald-500', bgColor: 'bg-green-50', textColor: 'text-green-700', borderColor: 'border-green-200' },
  { id: 'completed', label: 'завершен', icon: FaCheckCircle, color: 'from-green-500 to-emerald-500', bgColor: 'bg-green-50', textColor: 'text-green-700', borderColor: 'border-green-200' },

  { id: 'cancelled', label: 'Отмененные', icon: FaTimes, color: 'from-red-500 to-red-600', bgColor: 'bg-red-50', textColor: 'text-red-700', borderColor: 'border-red-200' },
];
